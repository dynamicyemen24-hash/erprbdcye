...
export async function applyEnterpriseViews(poolInstance: pg.Pool): Promise<void> {
  ...
  const viewColumnGuards = [
    ...
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS status VARCHAR(30) DEFAULT 'ACTIVE'`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS country VARCHAR(100) DEFAULT 'اليمن'`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS country_code VARCHAR(10) DEFAULT 'YE'`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS sub_district VARCHAR(100)`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS address TEXT`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS gps_latitude NUMERIC`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS gps_longitude NUMERIC`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS archetype VARCHAR(50) DEFAULT 'INDIVIDUAL'`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS entity_subtype VARCHAR(50)`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS phone_primary VARCHAR(50)`,
    `ALTER TABLE beneficiaries ADD COLUMN IF NOT EXISTS metadata JSONB DEFAULT '{}'`,

    `ALTER TABLE projects ADD COLUMN IF NOT EXISTS country VARCHAR(100) DEFAULT 'اليمن'`,
    `ALTER TABLE projects ADD COLUMN IF NOT EXISTS country_code VARCHAR(10) DEFAULT 'YE'`,
    `ALTER TABLE projects ADD COLUMN IF NOT EXISTS governorate VARCHAR(100)`,
    `ALTER TABLE projects ADD COLUMN IF NOT EXISTS district VARCHAR(100)`,
    `ALTER TABLE projects ADD COLUMN IF NOT EXISTS sub_district VARCHAR(100)`,
    `ALTER TABLE projects ADD COLUMN IF NOT EXISTS address TEXT`,
    `ALTER TABLE projects ADD COLUMN IF NOT EXISTS gps_latitude NUMERIC`,
    `ALTER TABLE projects ADD COLUMN IF NOT EXISTS gps_longitude NUMERIC`,

    `ALTER TABLE branches ADD COLUMN IF NOT EXISTS country VARCHAR(100) DEFAULT 'اليمن'`,
    `ALTER TABLE branches ADD COLUMN IF NOT EXISTS country_code VARCHAR(10) DEFAULT 'YE'`,
    `ALTER TABLE branches ADD COLUMN IF NOT EXISTS governorate VARCHAR(100)`,
    `ALTER TABLE branches ADD COLUMN IF NOT EXISTS district VARCHAR(100)`,
    `ALTER TABLE branches ADD COLUMN IF NOT EXISTS sub_district VARCHAR(100)`,
    `ALTER TABLE branches ADD COLUMN IF NOT EXISTS address TEXT`,
    `ALTER TABLE branches ADD COLUMN IF NOT EXISTS gps_latitude NUMERIC`,
    `ALTER TABLE branches ADD COLUMN IF NOT EXISTS gps_longitude NUMERIC`,
...
export async function seedEnterpriseUsersAndOrg(poolInstance: pg.Pool): Promise<void> {
  ...
  try {
    ...
    // 2. Ensure Standard Institutional Enterprise Users (Role-Based Titles, No Raw Personal Names)
    const users = [
      {
        email: 'admin@rohamaab.org',
        name_ar: 'مدير النظام العام والحوكمة المؤسسية',
      ...
      },
      {
        ...
        name_ar: 'المدير التنفيذي العام للمؤسسة',
      ...
      },
      {
        ...
        name_ar: 'المدير المالي والمحاسب القانوني',
        name_en: 'Chief Financial Officer & CPA',
        role: 'Financial Director',
        department_code: 'FINANCE',
        position_code: 'CHIEF_FINANCIAL_OFFICER',
        security_level: 5,
        can_approve: true,
        max_approval_amount: 75000000,
        phone: '+967-777000003',
        password_hash: defaultPasswordHash
      },
      {
      ...
      },
      {
        ...
        name_ar: 'مدير إدارة البرامج والمشاريع الإنسانية',
        name_en: 'Director of Humanitarian Programs & Projects',
        role: 'Programs Director',
        department_code: 'PROGRAMS',
        position_code: 'PROGRAMS_DIRECTOR',
        security_level: 4,
        can_approve: true,
      ...
      },
      {
        ...
        name_ar: 'مدير العمليات والتنفيذ الميداني',
        name_en: 'Operations & Field Execution Manager',
        role: 'Operations Manager',
        department_code: 'OPERATIONS',
        position_code: 'OPERATIONS_MANAGER',
        security_level: 4,
        can_approve: true,
      ...
      },
      {
        ...
        name_ar: 'مسؤول الرقابة والتقييم والمساءلة (MEAL)',
        name_en: 'MEAL & Compliance Lead Officer',
        role: 'MEAL Lead',
        department_code: 'MEAL_COMPLIANCE',
        position_code: 'MEAL_OFFICER',
        security_level: 4,
        can_approve: true,
      ...
      {
        email: 'sponsorship.officer@rohamaab.org',
        name_ar: 'مسؤول كفالة الأيتام والرعاية الاجتماعية',
        name_en: 'Orphan Care & Social Welfare Officer',
        role: 'Sponsorship Officer',
        department_code: 'SOCIAL_WELFARE',
        position_code: 'SPONSORSHIP_OFFICER',
        security_level: 3,
        can_approve: true,
        max_approval_amount: 15000000,
        phone: '+967-777000007',
        password_hash: defaultPasswordHash
      },
      {
        email: 'accountant.ops@rohamaab.org',
        name_ar: 'محاسب العمليات والصرف المالي',
        name_en: 'Operations & Field Disbursement Accountant',
      ...
      },
      {
        ...
        name_ar: 'مسؤول المشتريات والمناقصات وسلاسل الإمداد',
        name_en: 'Procurement, Tenders & Supply Chain Officer',
        role: 'Procurement Officer',
        department_code: 'PROCUREMENT',
        position_code: 'PROCUREMENT_OFFICER',
        security_level: 3,
        can_approve: true,
        max_approval_amount: 10000000,
        phone: '+967-777000009',
      ...
      },
      {
        ...
        name_ar: 'أمين المخازن المركزية وإدارة المخزون',
        name_en: 'Central Warehouse & Inventory Custodian',
      ...
      },
      {
        ...
        name_ar: 'ضابط المسح الميداني وتوزيع المساعدات',
        name_en: 'Field Survey & Aid Distribution Officer',
        role: 'Field Officer',
