...
export const beneficiaries = pgTable('beneficiaries', {
  ...
  gpsLatitude: numeric('gps_latitude'),
  gpsLongitude: numeric('gps_longitude'),
  archetype: text('archetype').default('INDIVIDUAL'),
...
// ==========================================
// 12b. NEB-08/NEB-10: COMMITMENTS & OBLIGATIONS OS
// ==========================================
export const commitments = pgTable('commitments', {
  id: uuid('id').primaryKey().defaultRandom(),
  organizationId: uuid('organization_id').references(() => organizations.id).notNull(),
  commitmentNumber: text('commitment_number').notNull(),
  commitmentType: text('commitment_type').default('BUDGET'),
  titleAr: text('title_ar').notNull(),
  titleEn: text('title_en'),
  description: text('description'),
  ...
  periodicity: text('periodicity').default('ONE_TIME'),
...
export const obligations = pgTable('obligations', {
  ...
  obligationType: text('obligation_type').default('RECURRING'),
  titleAr: text('title_ar').notNull(),
  titleEn: text('title_en'),
  description: text('description'),
  totalAmount: numeric('total_amount').default('0'),
  ...
  currencyCode: text('currency_code').default('YER'),
  periodicity: text('periodicity').default('MONTHLY'),
  ...
  status: text('status').default('DRAFT'),
  priority: text('priority').default('NORMAL'),
  obligationDate: timestamp('obligation_date'),
  startDate: timestamp('start_date'),
  endDate: timestamp('end_date'),
  nextDueDate: timestamp('next_due_date'),
...
export const obligationPayments = pgTable('obligation_payments', {
  id: uuid('id').primaryKey().defaultRandom(),
  organizationId: uuid('organization_id').references(() => organizations.id).notNull(),
  obligationId: uuid('obligation_id').references(() => obligations.id).notNull(),
  paymentNumber: text('payment_number').notNull(),
  paymentAmount: numeric('payment_amount').default('0'),
  currencyCode: text('currency_code').default('YER'),
  paymentDate: timestamp('payment_date'),
...
export const commitmentDocuments = pgTable('commitment_documents', {
  ...
  documentType: text('document_type').default('ATTACHMENT'),
