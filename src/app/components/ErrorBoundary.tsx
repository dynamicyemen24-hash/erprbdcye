  ...
  public render() {
    if (this.state.hasError) {
      ...
      const text = {
        ...
        description: isRtl 
          ? `تم الكشف عن خلل في هذا النطاق التشغيلي. تضمن هندسة ${SYSTEM_NAME} الذكية عزل الأخطاء لضمان استمرارية عمل باقي الخدمات والأنظمة دون انقطاع.` 
          : `An error occurred in this operational domain. ${SYSTEM_NAME} intelligent design isolates the issue to ensure other platform services run uninterrupted.`,
