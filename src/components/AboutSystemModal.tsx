...
const SCENARIO_STEPS = [
  {
    step: 1,
    domain: 'التخطيط',
    titleAr: 'وضع الخطة وتحديد الأهداف الاستراتيجية',
    titleEn: 'Strategic Planning & Goal Setting',
    descAr: 'تحديد أهداف المؤسسة ومؤشرات نجاحها، وتوزيع المسؤوليات على الفرق بشكل واضح ومنظم.',
    descEn: 'Define organizational goals and success indicators, assigning responsibilities to teams clearly and efficiently.',
    badge: 'التخطيط',
  ...
  },
  {
    step: 2,
    domain: 'المالية',
    titleAr: 'تخصيص الميزانيات ومتابعة الصرف والرقابة',
    titleEn: 'Budget Allocation & Expenditure Governance',
    descAr: 'تخصيص ميزانيات البرامج والمشاريع، ومتابعة عمليات الصرف بدقة مع ضمان الشفافية الكاملة.',
    descEn: 'Allocate program budgets, track expenditures accurately, and ensure full transparency across transactions.',
    badge: 'المالية',
  ...
  },
  {
    step: 3,
    domain: 'الميدان',
    titleAr: 'تنفيذ الأنشطة ومتابعة الفرق الميدانية',
    titleEn: 'Field Execution & Team Oversight',
    descAr: 'توثيق الأنشطة الميدانية وإسناد المهام للفرق، ومتابعة التقدم الفعلي مقارنةً بالخطة المعتمدة.',
  ...
  },
  {
    step: 4,
    domain: 'المستفيدون',
    titleAr: 'خدمة المستفيدين وتوصيل الدعم والإغاثة',
    titleEn: 'Beneficiary Services & Aid Delivery',
    descAr: 'إدارة بيانات الأسر والمستحقين، وإصدار سندات الكفالة والدعم بدقة وعدالة وفق معايير إسفير.',
  ...
  },
  {
    step: 5,
    domain: 'التقارير',
    titleAr: 'مراجعة النتائج واستخراج التقارير المعتمدة',
    titleEn: 'Results Review & Certified Reporting',
    descAr: 'مراجعة ما تحقق، واستخراج تقارير شاملة وموثوقة تعكس الأثر الفعلي لأعمال المؤسسة.',
