...
export function SmartCustomizationPanel({
  ...
  const widgetMetadata = [
    ...
    { key: 'domainOverview' as const, label_ar: 'لوحة توزيع نطاقات Nexora™', label_en: 'Nexora Enterprise Domains? Overview', desc_ar: 'خلاصة توزيع النطاقات الـ 15 ومستويات الاكتمال المؤسسي.', desc_en: 'Performance summaries across all 15 institutional domains.' },
