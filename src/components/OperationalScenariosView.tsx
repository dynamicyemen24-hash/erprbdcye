      ...
      steps: [
        {
          ...
          systemActionsAr: ['إنشاء وتفعيل السجل الوظيفي في المنظومة', 'تأمين وتشفير بيانات الدخول وفق المعايير المؤسسية', 'تخصيص الصلاحيات ومستويات الأمان بحسب الوصف الوظيفي'],
          systemActionsEn: ['Register active personnel profile in system', 'Securely encrypt access credentials', 'Assign permissions and security clearance according to job description'],
