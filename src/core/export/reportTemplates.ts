...
export const REPORT_TEMPLATES: Record<ReportTemplateId, ReportTemplate> = {
  general: {
    ...
    descriptionAr: 'تقرير شامل بالمؤشرات الرئيسية والإجمالي والتجميعات الإحصائية للمנתة',
    descriptionEn: 'Comprehensive report with key indicators, totals and statistical aggregations',
    icon: 'FileText',
